...
if (isset($_POST["btn"])) {
    ...
    $signin = "SELECT * FROM `children` WHERE email = ?";
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        if (password_verify($Pass2, $array['password'])) {
            ...
            $_SESSION['child_id'] = $array['id'];
            $_SESSION['fname'] = $array['firstname']; // Fetch first name
            $_SESSION['mname'] = $array['middlename']; // Fetch middle name
            $_SESSION['lname'] = $array['lastname']; // Fetch last name
              ...
              <div class="col-xl-5 col-lg-5">
                <div class="appointment-form p-24 mt-xl-0 mt-24">
                  ...
                  <form method="post" class="form-group mt-32">
                    ...
                    <!-- Alert Message -->
                    <br>
                    <a class="mt-4" href="signup.php">Not Registered ? Register</a>
