...
if (isset($_SESSION['user_id']) || isset($_SESSION['registration_step']) && $_SESSION['registration_step'] > 1) {
    header("Location: index.php"); // Redirect to the dashboard or appropriate page
    exit;
}
...
if (isset($_POST["btn"])) {
    ...
    if (empty($email) || !filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $insert = "INSERT INTO `children`(`email`, `password`, `date_created`) VALUES ('$email','$hashed_password','$date_created')";
        
            $run = mysqli_query($con, $insert);

            if ($run) {
                $childId = mysqli_insert_id($con); // Get the inserted child's ID
                $_SESSION['child_id'] = $childId; // Store child ID in session
                $_SESSION['registration_step'] = 1; // Step 1 completed
                header("Location: child_detail.php?id=" . $childId);
                exit();
            ...
            <div class="row d-flex justify-content-center align-items-center">
              ...
              <div class="col-xl-5 col-lg-5">
                <div class="appointment-form p-24 mt-xl-0 mt-24">
                  <h6 class="color-primary">Sign Up</h6>
                  ...
                  <form method="post" class="form-group mt-32">
                    ...
                    <button type="submit" class="cus-btn small-pad" name="btn">Register</button>
                    <!-- Alert Message -->
